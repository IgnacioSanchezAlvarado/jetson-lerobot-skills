---
description: Pre-flight check for demo setup at a new venue. Verifies Jetson connectivity, USB ports, cameras, services, and config alignment.
---

Run a complete pre-flight check for the demo hardware setup. SSH into the Jetson proactively — do not ask the user to run commands on their behalf.
...
> For full SSH setup, WiFi management, and venue workflows, read `set-up/02-setup_ssh-guide.md`.
...
- Network/SSH issues → `set-up/02-setup_ssh-guide.md`
- Serial port / arm / camera issues → `operations/01-lerobot_commands.md`
- Digital twin / MQTT / service errors → `operations/02-demo_platform.md`
- GR00T-specific issues → `troubleshooting/groot_inference_stuck.md`
